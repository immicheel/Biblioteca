...
var startText = { type: "tag", position: "start", value: "<w:t>", text: true };
var endText = { type: "tag", value: "</w:t>", text: true, position: "end" };
var startParagraph = { type: "tag", value: "<w:p>", text: false, position: "start" };
var endParagraph = { type: "tag", value: "</w:p>", text: false, position: "end" };
var delimiters = {
...
var fixtures = {
	...
	otherdelimiterssplitted: {
		...
		lexed: [startText, content("Hello "), delimiters.start, content("name"), delimiters.end, endText, { type: "tag", value: '<w:t foo="bar">', text: true, position: "start" }, content(", how is it ?"), endText],
		parsed: [startText, content("Hello "), { type: "placeholder", value: "name" }, endText, { type: "tag", value: '<w:t foo="bar">', text: true, position: "start" }, content(", how is it ?"), endText]
	},
	...
	dashloopnested: {
		...
		lexed: [{ type: "tag", position: "start", text: false, value: "<w:tr>" }, startParagraph, startText, delimiters.start, content("-w:tr columns"), delimiters.end, content(" Hello "), delimiters.start, content("-w:p users"), delimiters.end, delimiters.start, content("name"), delimiters.end, content(", "), delimiters.start, content("/users"), delimiters.end, endText, startText, delimiters.start, content("/columns"), delimiters.end, endText, endParagraph, { type: "tag", position: "end", text: false, value: "</w:tr>" }],
		parsed: [{ type: "tag", position: "start", text: false, value: "<w:tr>" }, startParagraph, startText, { type: "placeholder", value: "columns", location: "start", module: "loop", inverted: false, expandTo: "w:tr" }, content(" Hello "), { type: "placeholder", value: "users", location: "start", module: "loop", inverted: false, expandTo: "w:p" }, { type: "placeholder", value: "name" }, content(", "), { type: "placeholder", value: "users", location: "end", module: "loop" }, endText, startText, { type: "placeholder", value: "columns", location: "end", module: "loop" }, endText, endParagraph, { type: "tag", position: "end", text: false, value: "</w:tr>" }],
		postparsed: [{
	...
	selfclosing_with_placeholderr: {
		...
		lexed: [{ type: "tag", value: "<w:t />", text: true, position: "selfclosing" }, startText, content("Hi "), delimiters.start, content("user"), delimiters.end, endText],
		parsed: [{ type: "tag", position: "selfclosing", value: "<w:t />", text: true }, startText, content("Hi "), { type: "placeholder", value: "user" }, endText],
		postparsed: [{ type: "tag", position: "selfclosing", value: "<w:t />", text: true }, xmlSpacePreserveTag, content("Hi "), { type: "placeholder", value: "user" }, endText]
	}
